...
/*
  ...
  */
  ...
  var diag = document.createElement('img')
  diag.src = "uml.png"
  diag.style.width = "500px"

  var uml = document.getElementById ('diagram')
  uml.appendChild (diag)
  ...
  ex.addEventListener("mouseout", function() {
    ex.style.backgroundColor = "greenyellow";
  })
  ex.addEventListener("click", function() {
    var i = document.getElementById('webprev')
    alert(i.innerHTML)
  })
